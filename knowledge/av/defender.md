...
* [Defender](../../knowledge/av/defender.md)
    * [Defender Signature Database](../../knowledge/av/notes.md#defender-signature-database)
        * [Decompressing database](../../knowledge/av/notes.md#decompressing-database)
    * [Searching database](../../knowledge/av/notes.md#searching-database)
    * [Tools](../../knowledge/av/notes.md#tools)
        * [DefenderCheck](../../knowledge/av/notes.md#defendercheck)
    * [links](../../knowledge/av/notes.md#links-2)
...
The following script developed by Matt Graeber decompresses Windows Defender Antivirus signatures (`C:\ProgramData\Microsoft\Windows Defender\Definition Updates\{GUID}\mpavbase.vdm`)
```powershell
